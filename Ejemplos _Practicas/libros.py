...
-----------------------------------------------------\n")
    ...
    spinTitulo=Spinbox (ventana, value= (valores),
        ...
        textvariable=eliminarlibro,width=52) .place (x=112, y=470)
...
botonAnadir=Button (ventana, text="Añadir libro",\
    command=anadir, bg="indianRed3", fg="white") .place (x=550,y=38)

cFechaLimite=Entry (ventana, textvariable=fechalimite)\
.place (x=120,y=160)

spinTitulo=Label (ventana, text="Titulo leido:",\
    bg= colorFondo, fg= colorLetra) .place (x=30,y=470) 
botonLeido=Button (ventana, text="Libro ya leido",\
    command=eliminarLibro, bg="indianRed3",fg= "white") .place (x=550,y=465)
